...
import { Eye, EyeOff, Code2, Loader2, Mail, Lock, User } from 'lucide-react';
...
const RegisterPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (result.success) {
      toast.success('Welcome to CollabCode! 🎉');
      navigate('/dashboard');
    }
  };
    ...
    <div className="min-h-screen bg-surface-900 bg-hero-pattern flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md animate-slide-up">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-slate-400 mt-1 text-sm">Join CollabCode and start reviewing</p>
        </div>
